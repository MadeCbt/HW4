 ...
 */
 ...
 class myHashMap<K,V> {
     ...
     public V remove(K key) {
         // -----------------------------------------------------
         // 1. Compute the bucket index for the key.
         // -----------------------------------------------------
         int index = getBucketIndex(key);
 
         // -----------------------------------------------------
         // 2. Retrieve the head of the linked list at that bucket.
         // -----------------------------------------------------
         HashNode<K, V> head = bucket.get(index);
 
         // -----------------------------------------------------
         // 3. Initialize pointers for traversal.
         //    a. 'prev' to keep track of the previous node.
         //    b. 'curr' to traverse the linked list.
         // -----------------------------------------------------
         HashNode<K, V> prev = null;
         HashNode<K, V> curr = head;
 
         // -----------------------------------------------------
         // 4. Traverse the linked list in the bucket:
         //    a. While curr is not null, check if the current node's key equals the given key.
         //    b. If found:
         //         i. If prev is null, then the node to remove is at the head.
         //         ii. Else, bypass the current node by setting prev.next = curr.next.
         //         iii. Decrement the size of the hash map.
         //         iv. Return the value stored in the removed node.
         // -----------------------------------------------------
         while (curr != null) {
         ...
         // -----------------------------------------------------
         // 5. Key was not found in the bucket, return null.
         // -----------------------------------------------------
         return null;
     }
     ...
     public boolean remove(K key, V val) {
         ...
         // Key was found and its value equals the passed parameter 'val'
         remove(key);
         return true;
     }
     ...
     public V replace(K key, V val) {
         ...
         //    a. Check each node to see if its key equals the provided key.
         //    b. If found, store the old value, update the node's value, and return the old value.
         // -----------------------------------------------------
         while (curr != null) {
             if (curr.key.equals(key)) {
         ...
         // -----------------------------------------------------
         // 4. Key was not found, return null.
         // -----------------------------------------------------
         return null;
     }
     ...
     public boolean replace(K key, V oldVal, V newVal) {
         // -----------------------------------------------------
         // 1. Retrieve the current value associated with the key.
         // -----------------------------------------------------
         V currentValue = get(key);
 
         // -----------------------------------------------------
         // 2. Check if the key exists and its value matches oldVal:
         //    a. If currentValue is not null and equals oldVal, then:
         //         i. Call replace(K, V) to update the value.
         //         ii. Return true to indicate successful replacement.
         // -----------------------------------------------------
         ...
         // -----------------------------------------------------
         // 3. The key was not found or the current value did not match oldVal; return false.
         // -----------------------------------------------------
         return false;
     }
 
     /**
      * Method: boolean containsValue(V)
      *
      ...
      *
      * @param key: The key to search for to determine if the hash 
      *             map contains it
      *
      * @return: true if found, else false.
      */
      ...
      *
      * @return Set<Map.Entry<K,V>> - set of all K/V pairs in map
      */
